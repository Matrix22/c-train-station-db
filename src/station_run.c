...
void test_arrive_train() {
    FILE *f = fopen("out/output_arrive_train.out", "w");
    if (f == NULL) {
...
void test_leave_train() {
    FILE *f = fopen("out/output_leave_train.out", "w");
    if (f == NULL) {
        printf("Error opening file!\n");
        return;
    }
...
void test_find_express_train() {
    FILE *f = fopen("out/output_find_express_train.out", "w");
    if (f == NULL) {
        printf("Error opening file!\n");
        return;
    }
...
void test_find_overload_train() {
    FILE *f = fopen("out/output_find_overload_train.out", "w");
    if (f == NULL) {
        printf("Error opening file!\n");
        return;
    }
...
void test_find_optimal_train() {
    FILE *f = fopen("out/output_find_optimal_train.out", "w");
    if (f == NULL) {
        printf("Error opening file!\n");
        return;
    }
...
void test_find_heaviest_sequence_train() {
    FILE *f = fopen("out/output_find_heaviest_sequence_train.out", "w");
    if (f == NULL) {
        printf("Error opening file!\n");
        return;
    }
...
void test_order_train() {
    FILE *f = fopen("out/output_order_train.out", "w");
    if (f == NULL) {
        printf("Error opening file!\n");
        return;
    }
...
void test_fix_overload_train() {
    FILE *f = fopen("out/output_fix_overload_train.out", "w");
    if (f == NULL) {
        printf("Error opening file!\n");
        return;
    }
